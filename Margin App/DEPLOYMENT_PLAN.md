...
- **EBS Volume**: 
  - Root: 20GB gp3 (includes app, data, and logs)
...
# Update nginx.conf to reference the mounted file
# auth_basic_user_file /etc/nginx/.htpasswd;
```
...
- **Network Security**: Security groups restricting access
- **Authentication**: Nginx basic auth for internal team
...
### 9.1 Monthly AWS Costs (2025 Pricing)
- **EC2 t3.medium**: $30.37/month (on-demand, 24/7 usage)
- **EBS Storage (20GB gp3)**: $1.60/month (20GB × $0.08/GB)
- **CloudWatch Logs & Metrics**: $3-8/month (depends on log volume, first 5GB free)
- **SNS Email Notifications**: $0.02/month (assuming 1000 alerts/month, first 1000 free)
- **Elastic IP**: $3.60/month (public IPv4 address charge)
- **Data Transfer**: $2-5/month (depends on usage)
- **Total**: $41-48/month
